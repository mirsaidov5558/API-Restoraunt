...
namespace API_Restoran.Controllers
{
    ...
    {
        private readonly IDishService _srv;

        public DishesController(IDishService srv) => _srv = srv;

        [HttpGet]
        public async Task<IEnumerable<DishDto>> Get() => await _srv.GetAllAsync();
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Put(int id, UpdateDishDto dto)
